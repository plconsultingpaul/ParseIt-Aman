...
import type { InvoiceField, InvoiceConfig, InvoiceOrderByOption } from '../../types';
...
export default function FilterModal({
  ...
  const renderFilterInput = (field: InvoiceField) => {
      ...
      case 'string':
        return (
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-teal-500"
          />
        );
                      ...
                      <Select
                        ...
                        options={[
                          ...
                          ...config.orderByOptions
                            .filter((o: InvoiceOrderByOption) => o.field)
                            .map((o: InvoiceOrderByOption) => ({
                              value: o.field,
